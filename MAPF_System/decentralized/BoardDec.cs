...
namespace MAPF_System
{
    public class BoardDec : Board
    {
        ...
        public BoardDec(int X, int Y, Cell[,] Arr, List<UnitDec> units, string name, List<TunellDec> tunells)
        {
            this.name = name;
            this.X = X;
            this.Y = Y;
        ...
        public List<UnitDec> Units() { return units; }
        public int TunellId(int x, int y) { return ((TunellDec)Arr[x, y].Tunell()).Id(); }
        public bool InTunell(UnitDec unit, TunellDec tunell) { return Arr[unit.X(), unit.Y()].Tunell() == tunell; }
        ...
        public bool DelUnits()
        {
            ...
            units = new List<UnitDec> { units[0] };
            return true;
        }
        ...
        private void MakeBlock(BoardDec Board, int x, int y)
        {
