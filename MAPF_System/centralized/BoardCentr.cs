...
namespace MAPF_System
{
    public class BoardCentr : Board
    {
        ...
        public BoardCentr(int X, int Y, Cell[,] Arr, List<UnitCentr> units, string name, List<TunellCentr> tunells)
        {
            this.name = name;
            this.X = X;
            this.Y = Y;
        ...
        public bool InTunell(int unit_id, TunellCentr tunell) 
        {
        ...
        public List<UnitCentr> Units() { return units; }
        ...
        public bool DelUnits()
        {
            ...
            units = new List<UnitCentr> { units[0] };
            return true;
        }
        ...
        private void MakeBlock(BoardCentr Board, int x, int y)
        {
